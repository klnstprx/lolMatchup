...
func LiveGameForm() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<form id=\"liveGameForm\" hx-get=\"/livegame\" hx-trigger=\"submit\" hx-target=\"#liveGameResult\" hx-swap=\"innerHTML\" class=\"space-y-4\"><div><label class=\"block text-gray-700 font-bold mb-2\">Summoner Name</label> <input class=\"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline\" type=\"text\" name=\"summoner\" placeholder=\"Enter summoner name\"></div><div><button class=\"bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded\" type=\"submit\">Search Live Game</button></div></form><div id=\"liveGameResult\" class=\"mt-4\"></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
